...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="logreg-forms" >
        <form class="form-signin" action="control?action=register" method="post">
		    ...
		    %>
            <input type="text" id="inputEmail" class="form-control" placeholder="Name" required="" autofocus="" name="username" />
