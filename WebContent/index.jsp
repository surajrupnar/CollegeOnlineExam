...
<body>
        ...
        <header>
            ...
            <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="${pageContext.request.contextPath}/aboutus.jsp">About</a>
                    </li>
			    ...
			    <div class="dropdown-menu" aria-labelledby="dropdown03">
			        <a class="dropdown-item" href="${pageContext.request.contextPath}/login.jsp">Student</a>
				<a class="dropdown-item" href="${pageContext.request.contextPath}/adminlogin.jsp">Admin</a>
			    </div>
		    </li>
		    <li class="nav-item">
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-item active">
            ...
            <img src="${pageContext.request.contextPath}/pics/CarouselBG.png" />
        <div class="container">
          ...
          </div>https://stackoverflow.com/questions/1889076/what-are-the-recommendations-for-html-base-tag?noredirect=1&lq=1
        </div>
      </div>
